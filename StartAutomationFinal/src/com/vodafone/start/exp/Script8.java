...
public class Script8 {
	...
	private static Logger log = Logger.getLogger(Script8.class);
	...
	private final String TESTDATA_ROW = "Script8";
	...
	public void validateCTAPositive(String deviceName) 	{
...
/*******************************************************/
				...
				if(CTAfreq > 0){
					...
					for(int i=CTAfreq;i>0;i--){
						...
						log.info("verified CTA text. Clicking OK button for i="+i);
				...
				log.info("take screenshot");
				util.takeScreenShot(this.getClass().getSimpleName() + "-mainPagePositive");
