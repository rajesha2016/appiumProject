...
public class Script19 {
	...
	private final String TESTDATA_ROW = "Script19";
	...
	public void validateDashboardsInAppForFirstTimeUser(String deviceName) 	{
		...
		do{
			try{
				...
				log.info("waiting for page to load for 30 seconds");
				Thread.sleep(30000);
