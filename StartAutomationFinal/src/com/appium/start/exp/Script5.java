...
public class Script5 {
	...
	private static Logger log = Logger.getLogger(Script5.class);
	...
	private final String TESTDATA_ROW = "Script5";
	...
	public void validateDashboardURLs(String deviceName) 	{
		...
		try{
			...
			if(CTAfreq > 0){
					...
					log.info("verified CTA text. Clicking OK button");
